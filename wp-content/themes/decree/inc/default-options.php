...
if ( ! function_exists( 'decree_get_default_theme_options' ) ) :
	...
	function decree_get_default_theme_options() {
		...
		$options = array(
			'featured_content_bg_image'                     => trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/bg-featured-content.jpg',
			'promotion_headline_bg_image'                   => trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/bg-featured-content.jpg',
			'contact_page_bg_image'                         => trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/bg-featured-content.jpg',
			'logo_slider_bg_image'                          => trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/bg-featured-content.jpg',

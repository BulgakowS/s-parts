...
function decree_scripts() {
	...
	wp_enqueue_script( 'decree-navigation', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/navigation.min.js', array(), DECREE_THEME_VERSION, true );

	wp_enqueue_script( 'decree-skip-link-focus-fix', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/skip-link-focus-fix.min.js', array(), DECREE_THEME_VERSION, true );
	...
	// Load Font Awesome.
	wp_enqueue_style( 'font-awesome', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'css/font-awesome.min.css' );
	...
	if ( 'disabled' !== $options['news_ticker_option'] || 'disabled' !== $options['featured_slider_option'] || $options['testimonial_slider'] || 'disabled' !== $options['logo_slider_option'] ) {
		...
		if ( in_array( 'scrollVert', $transition_effects, true ) ) {
			wp_enqueue_script( 'jquery-cycle2-scrollVert', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/jquery.cycle/jquery.cycle2.scrollVert.min.js', array( 'jquery-cycle2' ), DECREE_THEME_VERSION, true );
		}

		if ( in_array( 'flipHorz', $transition_effects, true ) || in_array( 'flipVert', $transition_effects, true ) ) {
			// Flip transition plugin addition.
			wp_enqueue_script( 'jquery-cycle2-flip', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/jquery.cycle/jquery.cycle2.flip.min.js', array( 'jquery-cycle2' ), DECREE_THEME_VERSION, true );
		}

		if ( in_array( 'tileSlide', $transition_effects, true ) || in_array( 'tileBlind', $transition_effects, true ) ) {
			// tile transition plugin addition.
			wp_enqueue_script( 'jquery-cycle2-tile', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/jquery.cycle/jquery.cycle2.tile.min.js', array( 'jquery-cycle2' ), DECREE_THEME_VERSION, true );
		}

		if ( in_array( 'shuffle', $transition_effects, true ) ) {
			// Shuffle transition plugin addition.
			wp_enqueue_script( 'jquery-cycle2-shuffle', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/jquery.cycle/jquery.cycle2.shuffle.min.js', array( 'jquery-cycle2' ), DECREE_THEME_VERSION, true );
		}

		if ( 'disabled' !== $options['logo_slider_option'] ) {
			wp_enqueue_script( 'jquery-cycle2-carousel', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/jquery.cycle/jquery.cycle2.carousel.min.js', array( 'jquery-cycle2' ), DECREE_THEME_VERSION, true );
		}
	}
	...
	if ( ! $options['disable_scrollup'] ) {
		wp_enqueue_script( 'decree-scrollup', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/scrollup.min.js', array( 'jquery' ), '20072014', true );
	}

	wp_register_script( 'jquery-match-height', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/jquery.matchHeight.min.js', array( 'jquery' ), '20151215', true );

	/**
	 * Enqueue custom script for Decree.
	 */
	wp_enqueue_script( 'decree-custom-scripts', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/custom-scripts.min.js', array( 'jquery', 'jquery-match-height' ), '20150507', true );
	...
	// Load the html5 shiv.
	wp_enqueue_script( 'decree-html5', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/html5.min.js', array(), '3.7.0' );
...
function decree_enqueue_metabox_scripts( $hook ) {
	...
	// Scripts.
	wp_enqueue_script( 'decree-metabox', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/metabox.min.js', array( 'jquery', 'jquery-ui-tabs' ), '2013-10-05' );

	// CSS Styles.
	wp_enqueue_style( 'decree-metabox-tabs', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'css/metabox-tabs.css' );
}

 ...
 * @since Decree 0.1
 */
function decree_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function decree_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since Decree 0.1
 */
function decree_sanitize_page( $input ) {
 ...
 * @since Decree 0.1
 */
function decree_sanitize_category_list( $input ) {
	if ( '' !== $input  ) {
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 *                    the setting default.
 */
function decree_sanitize_number_range( $number, $setting ) {
 ...
 *
 * @see decree_sanitize_select()               https://developer.wordpress.org/reference/functions/decree_sanitize_select/
 ...
 */
function decree_sanitize_select( $input, $setting ) {
